...
describe("SearchBar", () => {
  test("should render searchbar component properly", () => {
  ...
  test("should call onQuery with the correct value after 700ms", async () => {
    ...
    // usar un setTimeout no es muy recomendado para este caso
    // screen.debug();
  ...
  test("should call onQuery with button clicked with the input value", () => {
    const onQuery = vi.fn();
    render(<SearchBar onQuery={onQuery} />);
